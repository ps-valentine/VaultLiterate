...
## Create New Coping Strategies (p. 56-60)
Now that you're familiar with all the distress tolerance skills, you can create new coping strategies for your future. The easiest way to do this is to examine some of the distressing situations you've experienced in the past and to identify how you've coped with them. Often, people with overwhelming emotions go through similar distressing situations over and over again. So in some ways these situations are predictable. In this exercise, you'll identify what those past situations were, how you coped with them, and what the unhealth consequences were. Then you'll identify what new coping strategies you can use in the future if you experience similar situations and what the healthier consequences might be as a result of using those new strategies.
...
Here's an example of preparing for both kinds of situations. Carl identified a distressing siutuation...

But these...
### Create New Coping Strategies for Distressing Situations When You're *With Someone Else*
### Create New Coping Strategies for Distressing Situations When You're Alone

On each worksheet, pick four...
