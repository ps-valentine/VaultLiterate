...
Then describe an action that "fits" your emotion. For example, if you are feeling bored, maybe that action would be to take a nap. Or if you are feeling shy, maybe the action would be to run away and hide. Do your best to describe the action, and write it near your drawing.
